...
<p>
I'm a Fullstack Engineer with a deep passion for building things that work smoothly behind the scenes. 
Currently studying at the University of Computer Science and Engineering in Skopje.
I enjoy building scalable systems, working with APIs, and turning complex domains into clean code.
Particular interest in the automotive and fintech industries.
<br><br>
Passionate about building modern applications with: <br>
☕ Java & Spring - Backend development with Spring Boot <br>
💻 C# & .NET – Backend development with ASP.NET Core & Web APIs <br>
🐍 Python - Data processing, AI integration, FastAPI services <br>
🤖 AI & MCP - Exploring Model Context Protocol and AI-powered applications <br>
